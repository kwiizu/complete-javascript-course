...
const restaurant = {
  ...
  orderPasta(ing1, ing2, ing3) {
    console.log(`Here is your delicicous pasta with ${ing1}, ${ing2} and ${ing3}`);
  },
...
console.log('Alex Wu'.split(' '));

const [firstName, lastName] = 'Alex Wu'.split(' ');
...
console.log (maskCreditCard(123455555555123));
...
const fixCapitalization = function(name) {
  const fixName = name;
  const passLow = fixName.toLocaleLowerCase();
  const passCorrect = passLow[0].toUpperCase() + passLow.slice(1);
  console.log(passCorrect);
}

fixCapitalization('aLEX');
...
const announcement = 'All passengersa come to boarding door 23. Boarding door 23!';
...
/* const question = new Map([
  ['question', 'What is the bestprogramming language in the world?'],
  [1, 'C'],
  [2, 'Java'],
  [3, 'JavaScript'],
  ['correct', 3],
...
const hoursMapp = new Map(Object.entries(openingHours));
console.log(hoursMapp);
...
console.log(new Set('alexwu').size ); */
...
console.log(restaurant.order.Pasta?.(0,1) ?? 'Method does not exist');
...
//If first value operant is Truthy value, imidietly return value in or operator.
// console.log(3 || 'Jonas');
// console.log( '' || 'Jonas');
// console.log(true || 0);
...
//   restaurant.orderPizza ('mushroomns', 'spinach');
// }
...
restaurant.orderPizza('mushroom', 'salami', 'cheeze'); */
//Spread operator (...)
/* const arr = [7,8,9];
...
// time: '22:30',
// adress: 'random adress11',
// mainIndex: 2,
// starterIndex: 2,
// });

// restaurant.orderDelivery({
// adress: 'random adress 11',
// starterIndex: 1,
// })
